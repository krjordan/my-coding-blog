...
tags: ['angular', 'angular-universal', 'pre-render', 'webpack']
authors: ['ryanjordan']
layout: PostLayout
summary: 'Pre-rendering your Angular app is a great way to improve performance and SEO. Here is a simple way to do it without using Angular Universal.'
---
