...
draft: false
tags: ['flexbox', 'css', 'sass', 'html']
authors: ['ryanjordan']
layout: PostLayout
summary: 'In this tutorial, we will make a navigation header using flexbox.'
---
...
<code class="language-css">flex-grow</code> is defined by [CSS-Tricks](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)
as
