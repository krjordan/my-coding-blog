...
tags: ['email', 'foundation', 'inky', 'gulp', 'npm', 'zurb']
authors: ['ryanjordan']
layout: PostLayout
summary: "I was recently tasked with building out an email newsletter. Honestly, I was dreading the task. Luckily, I did a bit of research before I started out on this adventure and found Foundation for Emails. It's well documented and even has a CLI."
---
