...
layout: PostLayout
summary: "In part II of this tutorial, we will get this random quote generator working with some jQuery. If you haven't read part I, I would suggest doing so now as I won't be covering any styling in this part of the tutorial."
---

In part II of this tutorial, we will get this random quote generator working with some jQuery. If you haven't read [part I](/blog/random-quote-part-I/), I would suggest doing so now as I won't be covering any styling in this part of the tutorial.
